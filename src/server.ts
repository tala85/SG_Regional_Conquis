...
const limiter = rateLimit({
  ...
  message: {
    status: "error",
    message:
      "Demasiadas peticiones desde esta IP. El escudo de seguridad se activó. Intente de nuevo en 15 minutos.",
  },
...
app.get("/api/estado", (req: Request, res: Response) => {
  res.status(200).json({
    status: "OK",
    mensaje:
      "Servidor del SG Regional Conquistadores funcionando impecable. 🏕️",
  });
});
    ...
    if (cantidadUsuarios === 0) {
      ...
      await prisma.usuario.create({
        data: {
          ...
          // 🧹 ACÁ BORRAMOS LA LÍNEA VIEJA DE "region"
        },
      });
    ...
    if (cantidadClases === 0) {
      ...
      await prisma.clase.createMany({
        data: [
          ...
          {
            nombre: "Amigo de la naturaleza",
            tipo: "AVANZADA",
            color: "#3B82F6",
            edadSugerida: 10,
          },
          {
            nombre: "Compañero de excurcionismo",
            tipo: "AVANZADA",
            color: "#EF4444",
            edadSugerida: 11,
          },
          {
            nombre: "Explorador de campo y de bosque",
            tipo: "AVANZADA",
            color: "#22C55E",
            edadSugerida: 12,
          },
          {
            nombre: "Pionero de nuevas fronteras",
            tipo: "AVANZADA",
            color: "#64748B",
            edadSugerida: 13,
          },
          {
            nombre: "Excursionista en el bosque",
            tipo: "AVANZADA",
            color: "#8B5CF6",
            edadSugerida: 14,
          },
          {
            nombre: "Guía de exploracion",
            tipo: "AVANZADA",
            color: "#EAB308",
            edadSugerida: 15,
          },
